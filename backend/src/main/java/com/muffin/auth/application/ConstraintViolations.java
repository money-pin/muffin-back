 ...
 *
 * <p>Hibernate/H2 조합에서는 제약 이름이 {@code PUBLIC.UK_EMAIL INDEX PUBLIC.UK_EMAIL_INDEX_1}처럼 원래 이름을 포함한
 * 형태로 내려오고, 대소문자도 보장되지 않아 정확히 일치시키지 않고 대소문자 무시 포함 여부로 판별한다(직접 예외를 발생시켜
 * 실제 메시지를 확인하고 검증함).
 */
