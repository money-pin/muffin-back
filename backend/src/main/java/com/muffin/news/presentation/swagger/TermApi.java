...
public interface TermApi {
    ...
    @Operation(
            summary = "용어 사전 조회 (CONTENT-05)",
            description = "뉴스 본문 하이라이트 용어를 탭했을 때 바텀시트에 표시할 용어 설명을 조회한다.",
            tags = {"News"})
    @ApiResponses({
    ...
    @Operation(
            summary = "용어 저장 (CONTENT-07-1)",
            description = "뉴스 본문 하이라이트 또는 용어 바텀시트에서 선택한 용어를 학습 저장소에 저장한다.",
            tags = {"News"})
    @ApiResponses({
    ...
    @Operation(
            summary = "용어 저장 해제 (CONTENT-07-2)",
            description = "학습 저장소에 저장된 용어를 해제한다. 이미 해제된 용어도 성공 상태로 반환한다.",
            tags = {"News"})
    @ApiResponses({
